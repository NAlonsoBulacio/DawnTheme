...
class MenuDrawer extends HTMLElement {
  ...
  onCloseButtonClick(event) {
    if (!event.currentElement.querySelector('disclosure__button')) {
...
// FAQ collapsibles start
$(document).on("click", ".meta_faq_que",function(){
  $(this).toggleClass("change_icon");
  $(this).parents(".meta_faq").find(".meta_faq_ans").slideToggle();
});
// FAQ collapsibles end

function getLocIdCookie(cname) {
  let name = cname + "=";
...
function setLocIdCookie(cname, cvalue, exdays) {
  const d = new Date();
...
//   if (getLocIdCookie('discount_code') != '') {
//     $('.discount_code .code').text(getLocIdCookie('discount_code'));
//     $('.discount_code').removeClass("hidden");
//   } else {
//     $('.discount_code').addClass("hidden");
//   }
// }
// Free shipping cart messages end
